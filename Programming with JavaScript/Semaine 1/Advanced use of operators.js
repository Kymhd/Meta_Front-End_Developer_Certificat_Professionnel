...
You are coding an RPG game, 
where each character has certain skill levels based on the value saved in their score.
...
Imagine you are coding a video game. 
Currently, you’re about to code some snippets related to the game over condition.
...
based on whether either the value of the timeRemaining 
variable is 0 or the value of the energy variable is 0.
...
console.log("Game over:", timeRemaning == 3 || energy == 0);
...
// it yourself with different values to explore the modulus operator.
